...
namespace CatEngine {
	...
	void Renderer2D::DrawQuad(const glm::vec2& position, float rotation, const glm::vec2& size, Ref<Texture2D>& texture, const glm::vec4& color, float tilingFactor)
	{
	...
	void Renderer2D::DrawQuad(const glm::vec3& position, float rotation, const glm::vec2& size, Ref<Texture2D>& texture, const glm::vec4& color, float tilingFactor)
	{
		...
		DrawQuad(GetTransform(position, rotation, size), texture, tilingFactor, color, -1);
	}

	void Renderer2D::DrawQuad(const glm::vec2& position, float rotation, const glm::vec2& size, Ref<SubTexture2D>& subTexture, const glm::vec4& color, float tilingFactor)
	{
		DrawQuad({ position.x, position.y, 0 }, rotation, size, subTexture, color, tilingFactor);
	}
	...
	{
		DrawCircle(transform, crc.Color, crc.Thickness, crc.Fade, (int)entityID);
	}
